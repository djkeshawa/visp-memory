---
name: visp-memory-maintenance
description: Maintain Visp Memory data quality and indexes from Codex, including memory strength/decay preview, intent lifecycle review, embedding reindex dry-runs, duplicate review, archived memories, audit logs, and exports.
---
