...
docker run -d --name visp-memory \
  ...
  ghcr.io/djkeshawa/visp-memory:0.7.9
...
![Visp Memory dashboard showing project totals, recent memories, and recall navigation](https://raw.githubusercontent.com/djkeshawa/visp-memory/v0.7.9/docs/dashboard-preview.png)
