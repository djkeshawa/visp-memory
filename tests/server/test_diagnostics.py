...
from visp_memory.core.indexing import ReindexResult
...
async def test_provider_diagnostics_get_does_not_verify_providers(client, monkeypatch):
    ...
    monkeypatch.setattr("visp_memory.core.embeddings.get_embedding_provider", fail_if_called)
...
async def test_provider_test_reports_openrouter_401_without_secret(client, monkeypatch):
    ...
    monkeypatch.setattr("visp_memory.core.embeddings.get_embedding_provider", fail_provider)
...
async def test_provider_test_reports_success(client, monkeypatch):
    ...
    monkeypatch.setattr("visp_memory.core.embeddings.get_embedding_provider", good_provider)
