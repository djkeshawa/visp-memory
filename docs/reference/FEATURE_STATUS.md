...
| [Dreaming cycles](../guides/DREAMING.md) | Beta | Scheduled SQLite/Neo4j cleanup, recoverable exact merges, and review suggestions. No model or vector index required. |
...
[benchmarks](BENCHMARK.md) for the evidence and [installation](../guides/INSTALLATION.md)
