...
against memory-grounded context built from llm-memory recall.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate deterministic A/B usefulness of llm-memory for agent tasks."
    )
...
def main() -> None:
    ...
    if args.data_dir:
        ...
        with tempfile.TemporaryDirectory(prefix="llm-memory-agent-ab-eval-") as tmpdir:
