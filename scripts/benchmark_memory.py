...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark Visp Memory core operations.")
...
def main() -> None:
    ...
    if args.data_dir:
        ...
        with tempfile.TemporaryDirectory(prefix="visp-memory-benchmark-") as tmpdir:
