...
try:
    # Distribution name on PyPI is "visp-memory-mcp" ("visp-memory" is owned by an
    # unrelated project); the import package and CLI stay "visp-memory".
    __version__ = version("visp-memory-mcp") if version else "0.2.3"
